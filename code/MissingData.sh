...
for subj in $DATA_DIR/*; do
    ...
    [ -d "$subj/MNINonLinear/Results/month24-rest-1" ] && R1="yes" || R1="no"
    [ -d "$subj/MNINonLinear/Results/month24-rest-2" ] && R2="yes" || R2="no"
    [ -d "$subj/MNINonLinear/Results/month24-task-MSIT" ] && MSIT="yes" || MSIT="no"
