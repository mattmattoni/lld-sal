...
for s = 1:size(Input.data,2)
    ...
    for i = 1:length(uCi)
        ...
        ft_write_cifti([OutDir '/temp_' num2str(i)],B,'parameter','data');
        ...
        C = ft_read_cifti([OutDir '/temp_' num2str(i) '.dtseries.nii']); % read in CIFTI post-removal of small networks;
...
ft_write_cifti([OutDir '/' Output],O,'parameter','data');
